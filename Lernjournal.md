...
In einer Tabelle wird das Alphabet mehrmals verschoben:   
ABCDE..   
BCDEF..   
CDEFG..   

Es gibt einen Klartext (Nachricht) und einen Schlüssel (Schlüsselwort).   
Der Buchstabe vom Schlüssel wird in der Tabelle (links) eingetragen, während der des Klartexts oben eingetragen wird. Der, auf dem sie sich in der Tabelle übertragen wir übernommen.   
Bsp:   
Klartext: INFORMATIK  
Schlüsselwort: SPION   
...
Symmetrische VerschlüsselungCäsar, Vigenègre, AES, OTPEs gibt einen Schlüssel der zum verschlüsseln und entschlüsseln verwendet wird.
...
Man muss die Hybride Verschlüsselung nutzen--> Deutlich schneller--> Sicheherit verbesser mit länge.

**Ciphertext-Only-Angriff**   
Wenn man den Geheimtext abhöhren konnte --> Durch reines Ausprobieren rausfinden.   

**Know-Plaintext- Angriff**   
